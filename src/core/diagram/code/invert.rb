...
module Invert
  ...
  module InvertExpr
    ...
    def invert_EBinOp(obj)
      ...
      when "+"
        if obj.e1.EConst?
          dynamic_bind val: (val-obj.e1.val) do; invert(obj.e2) end
        elsif obj.e2.EConst?
          dynamic_bind val: (val-obj.e2.val) do; invert(obj.e1) end
        end
      else
