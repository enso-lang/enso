...
function() {
  var Constraints ;
  var ConstraintSystem = MakeClass("ConstraintSystem", null, [],
    function() {
    },
    function(super$) {
      ...
      this.var = function(name, value) {
        var self = this; 
        if (name === undefined) name = S("v", self.$.number);
  ...
  var Constant = MakeClass("Constant", null, [],
    function() {
    },
    function(super$) {
  ...
  var TrueClass = MakeClass("TrueClass", null, [],
    function() {
    },
    function(super$) {
  ...
  var FalseClass = MakeClass("FalseClass", null, [],
    function() {
    },
    function(super$) {
      this.test = function(a, b) {
  ...
  var Variable = MakeClass("Variable", Constant, [],
    function() {
    },
    function(super$) {
      ...
      this.do_op = function(op) {
        var self = this; 
        var values = compute_rest_arguments(arguments, 1);
        switch (op) {
          case "add":
      ...
      this.internal_define = function(block) {
        var self = this; 
        var vars = compute_rest_arguments(arguments, 1);
        if (self.$.block) {
        ...
        self.$.vars = vars.map(function(v) {
          ...
          } else if (System.test_type(v, Constant)) {
            return v;
          } else {
      ...
      this.internal_evaluate = function(path) {
        ...
        if (path.include_P(self)) {
          self.raise(S("circular constraint ", path.map(function(x) {
            return x.to_s();
          })));
        }
        if (self.$.block) {
