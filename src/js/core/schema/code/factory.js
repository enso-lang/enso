define(["core/schema/code/dynamic", "core/system/utils/paths", "core/system/library/schema", "core/semantics/code/interpreter", "core/expr/code/impl", "core/expr/code/env", "core/expr/code/freevar"], (function (Dynamic, Paths, Schema, Interpreter, Impl, Env, Freevar) {
  var Factory;
  var SchemaFactory = MakeClass("SchemaFactory", null, [], (function () {
  }), (function (super$) {
    ...
    (this.set_file_path = (function (val) {
      (this.$.file_path = val);
    }));
    ...
    (this.unsafe_mode = (function (body) {
      var self = this;
      (self.$.unsafe = (self.$.unsafe ? (self.$.unsafe + 1) : 1));
      body();
      return (self.$.unsafe -= 1);
    }));
  ...
  var MObject = MakeClass("MObject", EnsoProxyObject, [], (function () {
    ...
    (this.extra_instance_data = (function () {
      return this.$.extra_instance_data;
    }));
    (this.set_extra_instance_data = (function (val) {
      (this.$.extra_instance_data = val);
    }));
    (this.props = (function () {
      return this.$.props;
    }));
    ...
    (this.initialize = (function (klass, factory) {
      var self = this;
      var args = compute_rest_arguments(arguments, this.initialize.length);
    ...
    (this.__is_a = (function (klass) {
      ...
      return klass.schema().classes().each((function (cls) {
        var val;
        (val = (function () {
          return Schema.subclass_P(klass, cls);
        })());
    ...
    (this.__computed = (function (fld) {
      var self = this;
      var val, c, fvInterp, name, base, exp;
      ...
      return self.define_singleton_method((function () {
        ...
        if ((val == null)) {
          ...
          (val = Impl.eval(exp, (new EnsoHash({
            env: Env.ObjEnv.new(self)
          }))));
          if (fld.many()) {
            if ((key = fld.type().key())) { 
    ...
    (this._path = (function () {
      var self = this;
      if ((self.$.path == null)) {
        (self.$.path = (self.__shell() ? self.__shell()._path(self) : Paths.Path.new()));
      }
      return self.$.path;
    }));
  ...
  var Field = MakeClass("Field", null, [], (function () {
  }), (function (super$) {
    (this._origin = (function () {
      return this.$._origin;
    }));
  ...
  var Single = MakeClass("Single", Field, [], (function () {
  }), (function (super$) {
    (this.initialize = (function (owner, field) {
      var self = this;
  ...
  var Prim = MakeClass("Prim", Single, [], (function () {
  }), (function (super$) {
    ...
    (this.check = (function (mobj) {
      ...
      if ((!self.$.owner._graph_id().unsafe_P())) {
        if ((mobj || (!self.$.field.optional()))) {
          ...
          try {if ((!Schema.subclass_P(mobj.schema_class(), self.$.field.type()))) {
  ...
  var Ref = MakeClass("Ref", Single, [RefHelpers], (function () {
  }), (function (super$) {
    (this.set = (function (value) {
      var self = this;
      self.check(value);
  ...
  var Many = MakeClass("Many", Field, [RefHelpers, Enumerable], (function () {
  }), (function (super$) {
    (this.get = (function () {
      var self = this;
      return self;
  ...
  var Set = MakeClass("Set", Many, [SetUtils], (function () {
  }), (function (super$) {
    ...
    (this._recompute_hash_C = (function () {
      var self = this;
      var nval;
      (nval = (new EnsoHash({
  ...
  var List = MakeClass("List", Many, [ListUtils], (function () {
  }), (function (super$) {
    (this.initialize = (function (owner, field) {
      var self = this;
      super$.initialize.call(self, owner, field);
