define([], (function () {
  var Equals;
  var Equals = MakeClass("Equals", null, [], (function () {
    ...
    (this.equals = (function (a, b) {
      ...
      if ((a == b)) { 
        ...
        if ((((a == null) || (b == null)) || (a.schema_class().name() != b.schema_class().name()))) { 
          return false; 
        }
        else { 
          if (self.$.memo._get([a, b])) { 
            return true; 
          } 
          else {
                 (res = true);
                 ...
                 a.schema_class().fields().each((function (field) {
                   ...
                   if (field.type().Primitive_P()) { 
                     ...
                     if ((!field.many())) { 
                       ...
                       if (System.test_type(a_val, self.Factory().List)) { 
                         if ((!self.equals_list(a_val, b_val))) {
                           return (res = false);
                         } 
                       }
                       else { 
                         if (System.test_type(a_val, self.Factory().Set)) { 
