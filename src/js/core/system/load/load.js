...
function(Schema, MetaSchema, Factory, Parse, Union, Rename, Cache, FindModel) {
  var Load ;
  ...
  var LoaderClass = MakeClass("LoaderClass", null, [],
    ...
    function(super$) {
      ...
      this.setup = function() {
        ...
        return self.$.cache._set("schema.grammar", self.load_with_models("schema_grammar.json", null, gs));
      };
