define(["core/expr/code/env", "core/expr/code/eval", "core/schema/code/factory", "core/system/load/load"], (function (Env, Eval, Factory, Load) {
  var Proxy;
  var Proxy = MakeClass("Proxy", null, [], (function () {
    (this.$.factory = null);
    (this.new = (function () {
      var self = this;
      ...
      if ((System.test_type(args._get(0), TrueClass) || System.test_type(args._get(0), FalseClass))) { 
        ...
        return super$.new.apply(self, [].concat(args));
      }
    }));
  }), (function (super$) {
    (this._val = (function () {
    ...
    (this._sources = (function () {
      return this.$._sources;
    }));
    (this.set__sources = (function (val) {
      (this.$._sources = val);
    }));
    (this._tree = (function () {
      return this.$._tree;
    }));
    (this.set__tree = (function (val) {
      (this.$._tree = val);
    }));
    undefined;
    ...
    (this.method_missing = (function (block, sym) {
      var self = this;
      var args = compute_rest_arguments(arguments, this.method_missing.length);
      var res, f, other, newlist;
    ...
    (this.hash = (function () {
      var self = this;
      return self.method_missing("hash");
    }));
