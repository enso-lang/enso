define(["core/expr/code/eval", "core/expr/code/env", "core/schema/tools/print", "core/schema/code/factory", "core/system/utils/paths", "core/system/library/schema", "core/semantics/code/interpreter"], (function (Eval, Env, Print, Factory, Paths, Schema, Interpreter) {
  ...
  var RenderGrammar = MakeMixin([Interpreter.Dispatcher], (function () {
    ...
    (this.render_Grammar = (function (this_V) {
      ...
      if (self.$.slash_keywords) {
        (self.$.literals = self.Scan().collect_keywords(this_V));
      }
      ...
      (ok = this_V.elements().all_P((function (x) {
        ...
        if (item) {
          if ((item == true)) { 
            ...
            if (System.test_type(items, Array)) { 
    ...
    (this.render_Create = (function (this_V) {
      ...
      if (((!(obj == null)) && (obj.schema_class().name() == this_V.name()))) {
        ...
        (res = self.dynamic_bind((function () {
          ...
          stream: SingletonStream.new(obj)
        }))));
        if (res) {
          (self.$.success += 1);
        }
    ...
    (this.render_Field = (function (this_V) {
      var self = this;
      var data, fld, res, stream, obj, format;
      (stream = self.$.D._get("stream"));
      (obj = stream.current());
      if (this_V.arg().Lit_P()) { 
    ...
    (this.render_Value = (function (this_V) {
      ...
      (obj = stream.current());
      if ((!(obj == null))) {
        if ((!((System.test_type(obj, String) || System.test_type(obj, self.Fixnum())) || System.test_type(obj, self.Float())))) {
        ...
        switch ((function () {
          ...
          case "real":
           if (System.test_type(obj, self.Float())) {
             return self.output(obj.to_s());
           }
          case "int":
           if (System.test_type(obj, self.Fixnum())) {
             return self.output(obj.to_s());
           }
          case "sym":
           if (System.test_type(obj, String)) {
    ...
    (this.render_Code = (function (this_V) {
      var self = this;
      var stream, rhs, obj, lhs;
      (stream = self.$.D._get("stream"));
      (obj = stream.current());
      if ((this_V.expr().EBinOp_P() && (this_V.expr().op() == "eql?"))) {
        (rhs = Eval.eval(this_V.expr().e2(), (new EnsoHash({
          env: Env.ObjEnv.new(obj, self.$.localEnv)
        }))));
        if (System.test_type(rhs, Factory.MObject)) {
          (lhs = Eval.eval(this_V.expr().e1(), (new EnsoHash({
            env: Env.ObjEnv.new(obj, self.$.localEnv)
          }))));
          return (lhs.schema_class() == rhs.schema_class());
        }
        else {
          return Eval.eval(this_V.expr(), (new EnsoHash({
            env: Env.ObjEnv.new(obj, self.$.localEnv)
          })));
        }
      }
  ...
  var PredicateAnalysis = MakeClass("PredicateAnalysis", null, [], (function () {
  }), (function (super$) {
  ...
  var SingletonStream = MakeClass("SingletonStream", null, [], (function () {
  }), (function (super$) {
    (this.initialize = (function (data, used) {
      var self = this;
      (used = (((typeof used) !== "undefined") ? used : false));
      (self.$.data = data);
      return (self.$.used = used);
    }));
    (this.size = (function () {
      var self = this;
      return (self.$.used ? 0 : 1);
    }));
    (this.current = (function () {
      var self = this;
      return (self.$.used ? null : self.$.data);
    }));
    (this.next = (function () {
      var self = this;
  ...
  var ManyStream = MakeClass("ManyStream", null, [], (function () {
  }), (function (super$) {
    (this.initialize = (function (collection, index) {
      var self = this;
      (index = (((typeof index) !== "undefined") ? index : 0));
      (self.$.collection = (System.test_type(collection, Array) ? collection : collection.values()));
      (self.$.index = index);
    ...
    (this.current = (function () {
      var self = this;
      return ((self.$.index < self.$.collection.size()) ? self.$.collection._get(self.$.index) : null);
    }));
    (this.next = (function () {
      var self = this;
  ...
  var DisplayFormat = MakeClass("DisplayFormat", null, [RenderGrammar], (function () {
    (this.print = (function (grammar, obj, output, slash_keywords, add_tags) {
      var self = this;
      (output = (((typeof output) !== "undefined") ? output : System.stdout()));
      (slash_keywords = (((typeof slash_keywords) !== "undefined") ? slash_keywords : true));
      (add_tags = (((typeof add_tags) !== "undefined") ? add_tags : false));
