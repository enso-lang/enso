...
\title{\includegraphics[scale=0.25]{enso.jpg}\\  Managed Objects:\\ Structure and Interpretation of Data in \Enso}
...
\begin{abstract}
Managed Objects allow programmers to define or modify the
fundamental data definition mechanisms in a programming language. 
The programmer can change the language used to define data, implement
...
Managed Objects allow programmers to override the field/method
access operator (the ``dot operator''). Managed Objects allow
...
data used to implement Managed Objects, is managed.
This paper describes the implementation of Managed Objects
...
This paper presents Managed Objects, an approach to data definition
...
Managed Objects has four main features: (1) high-level \textit{data models}
...
that allows all Managed Objects, including data models, to be customized
...
data definition that is used to build the Managed Objects system itself.
...
Managed Objects supports controlled imperative effects. Objects are
...
Managed Objects is based on traditional 
