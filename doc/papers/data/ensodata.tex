...
Managed Data has four main requirements: 
(1) definition of \textit{data description languages} that 
describe the desired structure and properties of data,
(2) implementation of \textit{data managers} that interpret a data description language
and enable creation and manipulation of instances of data that conform
to the description,
(3) \textit{integration} with a programming language, so that managed data instances can be
created and manipulated, 
and (4) a \textit{bootstrapping} process that enables data managers to use
managed data in their implementation. 

Managed Data places strong requirements on the host programming language, to 
support use-defined description and management of data.
...
In this paper we illustrate the concept of Managed Data in Ruby, a dynamic object-oriented
...
changes to the way data is described and managed in a programming language? 
There are
several ways to approach this question, but one concrete example is to
consider what it would mean to override the ``dot'' operator, which 
selects a field of a structure or object in many languages. One might also
