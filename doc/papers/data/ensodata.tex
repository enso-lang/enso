...
This section develops a series of increasingly powerful
Managed Data mechanisms.
...
class BasicRecordManager
  ...
  def method_missing(name, *args)
    if name =~ /(.*)=/
      name = $1.to_sym
      raise "assigning unknown field #{name}" if !@fields[name]
      raise "#{name} must be #{@fields[name]}" if @fields[name] != args[0].class
      @values[name] = args[0]
    else
