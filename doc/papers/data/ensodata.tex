...
Scheme macros can be used to create data structuring mechanisms, 
for example \lstinline{defstruct}.


This paper presents the approach to defining 
data structuring mechanisms used that is used in \Enso.
