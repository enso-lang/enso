...
\Enso\ Data has three main features: (1) high-level data modeling languages
for describing the structure and behavior of data, (2) 
dynamic interpreters of data descriptions that manage the data
instances described in a data model, and (3) a bootstrapping model
that allows all \Enso\ Data, including meta-data, to be customized
and managed using the approach. The \Enso\ approach to data
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.55]{DDL.pdf}
